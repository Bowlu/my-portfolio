    ...
    <div className="portfolio scroll-smooth">
      <div>
        <div className="bg-[#d5a397] h-[30vh]">
          ...
          <div className="header">
            <div className="pic-container absolute top-[30px] object-cover w-[100%] h-[50vh]  flex justify-center">
              <img src={Pic} alt="my profile" className="rounded-full border-[8px] border-[#d5a397]"></img>
            </div>
          </div>
        </div>
      </div>
      <div className="body-container mt-[13rem]">
        <div className="body-header">
          <p className="body-text text-[40px] text-center text-neutral-700 font-bold">Awoyemi Boluwatife Victoria</p>
        </div>
        <div className="flex justify-center">
          <div className="bio p-3 text-[18px] w-[80%] text-justify leading-loose">
      ...
      <div>
        <div className="mt-[8rem]">
          <div className="flex justify-center">
            <p className="headings text-[30px] text-neutral-600 font-bold text-center">LANGUAGES</p>
          </div>
          <div className="flex justify-evenly mt-[5rem]">
            <img src={Html} alt="HTML" className="lang html w-[15%]"></img>
            <img src={Css} alt="CSS" className="lang w-[10%]"></img>
            <img src={Js} alt="JS" className="lang w-[10%]"></img>
          </div>
        </div>
        <div className="mt-[6rem]">
          <div className="flex justify-center">
            <p className="headings text-[30px] text-neutral-600 font-bold text-center">FRAMEWORKS</p>
          </div>
          <div className="flex justify-evenly mt-[5rem]">
            <div className="icon w-[10%]">
              <img src={ReactIcon} alt="React"></img>
            </div>
            <img src={Vite} alt="Vite" className="icon w-[10%]"></img>
            <div className="icon vary w-[20%]">
              <img src={Next} alt="Next"></img>
            </div>
            <img src={Tail} alt="Tailwind" className="icon w-[10%]"></img>
          </div>
        </div>
        <div className="mt-[6rem]">
          <div className="flex justify-center">
            <p className="headings text-[30px] text-neutral-600 font-bold text-center">PROJECTS</p>
          </div>
          ...
          <div className="view-container flex justify-center">
            <button className="view w-[25%] h-[50px] rounded-[40px] text-white font-bold mt-[3rem] bg-[#8c53bb] hover:bg-[#861edb] relative top-[-300px] left-[350px] shadow-lg"><a href="https://patricia-clone.vercel.app">View page</a></button>
          </div>
          <div className="flex flex-wrap m-5">
            <img src={Climate} alt="climate" className="project w-[25%] m-4 shadow-lg transition-transform transform hover:scale-110"></img>
            <img src={Workshop} alt="workshop" className="project w-[25%] m-4 shadow-lg transition-transform transform hover:scale-110"></img>
            <img src={Surprise} alt="surprise" className="project w-[25%] m-4 shadow-lg transition-transform transform hover:scale-110"></img>
            <img src={Staytuned} alt="staytuned" className="project w-[25%] m-4 shadow-lg transition-transform transform hover:scale-110"></img>
            <img src={Apply} alt="apply" className="project w-[25%] m-4 shadow-lg transition-transform transform hover:scale-110"></img>
            <img src={Welcome} alt="welcome" className="project w-[25%] m-4 shadow-lg transition-transform transform hover:scale-110"></img>
            <img src={Design} alt="design" className="project w-[25%] m-4 shadow-lg transition-transform transform hover:scale-110"></img>
          </div>
        </div>
        <div className="mt-[6rem]">
          <div className="flex justify-center">
            <p className="headings text-[30px] text-neutral-600 font-bold text-center">CONNECT WITH ME: </p>
          </div>
        ...
        <div className="flex justify-center mt-[6rem] text-neutral-400 text-[20px]">Designed by Awoyemi Boluwatife</div>
      </div>
    </div>
  )
}
